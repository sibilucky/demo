pipeline {
    ...
    parameters {
        choice(name: 'REPOSITORY', choices: ['https://github.com/sibilucky/demo.git'], description: 'Select the Git repository URL')
    ...
    environment {
        REPO_URL = "https://github.com/sibilucky/demo.git"  // Use the parameterized repository URL
    ...
    stages {
        stage('Checkout') {
            steps {
                script {
                    echo "Checking out code from repository:https://github.com/sibilucky/demo.git , branch: main"
                    git url: "https://github.com/sibilucky/demo.git", branch: "main"
                }
            }
        }
